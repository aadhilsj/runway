...
export default function AccountsRoute() {
  ...
  return <Page className="accounts-page" eyebrow="Where your money lives" title="Accounts" description="See the real balance of each bank, cash, or debt account. Record money in Activity when a balance changes.">
